...
def validate_request_complexity(start_date: Optional[datetime] = None, end_date: Optional[datetime] = None) -> None:
...
def validate_admin_authentication(current_admin: User) -> None:
...
def validate_database_session(session: Session) -> None:
...
def handle_report_error(error: Exception, operation: str) -> HTTPException:
    """Centralized error handling for report endpoints"""
...
async def get_user_activity_report(
    ...
    validate_admin_authentication(current_admin)
    # Enhanced database session validation
    validate_database_session(session)
    ...
    try:
        ...
        validate_request_complexity(_start_date, _end_date)
        ...
        raise handle_report_error(e, "user activity report generation")
...
async def get_book_circulation_report(
    ...
    try:
        ...
        # Use centralized error handler
        raise handle_report_error(e, "book circulation report generation")
...
async def get_overdue_summary_report(
    ...
    try:
        ...
        # Use centralized error handler
        raise handle_report_error(e, "overdue summary report generation")
...
async def get_inventory_status_report(
    ...
    try:
        ...
        # Use centralized error handler
        raise handle_report_error(e, "inventory status report generation")
...
async def export_excel_report(
    ...
    try:
        ...
        try:
            ...
            # Use centralized error handler
            raise handle_report_error(wb_error, "Excel workbook creation")
        ...
        try:
            ...
            # Use centralized error handler
            raise handle_report_error(data_error, "report data processing for Excel")
        ...
        try:
            ...
            # Use centralized error handler
            raise handle_report_error(save_error, "Excel file saving")
        ...
        # Use centralized error handler
        raise handle_report_error(e, "Excel export operation")
